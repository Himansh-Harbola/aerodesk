  ...
  return (
    <form action={submit} className="mt-8 grid overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm lg:grid-cols-[1fr_1fr_0.9fr_0.8fr_auto]">
      <label className="grid min-h-24 gap-1 border-b border-slate-200 px-5 py-4 text-sm font-bold text-slate-600 lg:border-b-0 lg:border-r">
        Origin
        <input className="focus-ring min-w-0 text-lg font-medium text-slate-950 outline-none" name="origin" defaultValue={initial.origin} placeholder="Delhi" />
      </label>
      <label className="grid min-h-24 gap-1 border-b border-slate-200 px-5 py-4 text-sm font-bold text-slate-600 lg:border-b-0 lg:border-r">
        Destination
        <input className="focus-ring min-w-0 text-lg font-medium text-slate-950 outline-none" name="destination" defaultValue={initial.destination} placeholder="Mumbai" />
      </label>
      <label className="grid min-h-24 gap-1 border-b border-slate-200 px-5 py-4 text-sm font-bold text-slate-600 lg:border-b-0 lg:border-r">
        Date
